...
export const testimonials = [
  {
    quote:
      '• Designed and implemented a price indexing module that compares our client prices with competitor prices.',
    quote2:
      '• Added advanced filtering options to analyze product affinity within specific categories. ',
    quote3:
      '• Improved the application’s user interface and overall user experience, ensuring seamless interaction and usability.',
  ...
  {
    quote:
      '• Developed the startup’s official website. wisevision.io',
    quote2:
      '• implemented heatmaps and visual analytics represents customer traffic patterns and movements within retail spaces.',
    quote3:
  ...
  {
    quote:
      '• Improved the CRM interface and added an email address verification system.',
    quote2:
      '• integrated a real-time chat functionality into the application ',
    quote3:
